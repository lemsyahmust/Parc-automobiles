...
Public Class CrysBénéficiaire
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vehicule01.CrysBénéficiaire.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysBénéficiaire
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysBénéficiaire = New CrysBénéficiaire
        rpt.Site = Me.Site
        Return rpt
    End Function
