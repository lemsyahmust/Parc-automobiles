...
Public Class CrysTypeRepTion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vehicule01.CrysTypeRepTion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysTypeRepTion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysTypeRepTion = New CrysTypeRepTion
        rpt.Site = Me.Site
        Return rpt
    End Function
