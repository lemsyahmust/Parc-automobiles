...
Public Class CrysAffectation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vehicule01.CrysAffectation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysAffectation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysAffectation = New CrysAffectation
        rpt.Site = Me.Site
        Return rpt
    End Function
