<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="Supprimervidange.aspx.vb" Inherits="Vehicule01.WebForm23" 
    title="Page sans titre" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

<center style="width: 1120px">
<h2> <i>Suppression&nbsp; de&nbsp; Vidange</i></h2>
        ...
        <tr>
          ...
          <table style="width: 863px; height: 271px; border-collapse: collapse;">
             ...
             <tr>
                    ...
                    <td >
                        <asp:RadioButton ID="RadHuile" runat="server" ForeColor="Blue" Font-Size="Medium" Font-Names="Garamond"  GroupName="MyGroup" Text="Numéro Huile" AutoPostBack="true" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <tr>
                    <td style="width: 163px">
                        <asp:Label ID="lblNHuile" runat="server" Font-Bold="True" Height="22px" Text=" Numéro du Huile " Width="135px"></asp:Label></td>
                    <td >
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="cbxNHuile" runat="server" AutoPostBack="True" Enabled="false" Width="158px">
                        </asp:DropDownList>
                        <asp:Label ID="lblNCons" runat="server" Font-Bold="True" Height="22px" Text="" Width="5px"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="lblNHuilee" runat="server" Font-Bold="True" Height="22px" Text="" Width="5px"></asp:Label>
                    </td>
                   </tr>
                  ...
                  <tr>
                    ...
                    <tr>
                     <td style="width: 163px">
                       ...
                       <br />
                        <asp:Button ID="btnsuppPneus" runat="server" Font-Bold="True" Height="26px" Text="Supprimer" Width="99px" Font-Italic="True" Font-Names="Garamond" Font-Overline="False" 
                               Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" ForeColor="Blue" Visible="True"></asp:Button>
                               
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                            
                       <asp:Button ID="BtnEnd" runat="server" Font-Bold="True" Font-Names="Garamond" 
                               Height="26px" Width="99px" font-Overline="False" Font-Size="Medium" 
                               ForeColor="blue" Text="Retour" PostBackUrl="~/Vidange.aspx" />
                       </td>                     
                    </tr>
