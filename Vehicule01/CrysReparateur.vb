...
Public Class CrysReparateur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vehicule01.CrysReparateur.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysReparateur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysReparateur = New CrysReparateur
        rpt.Site = Me.Site
        Return rpt
    End Function
