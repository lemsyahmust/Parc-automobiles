...
Public Class CrysReparation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vehicule01.CrysReparation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysReparation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysReparation = New CrysReparation
        rpt.Site = Me.Site
        Return rpt
    End Function
