...
Public Class CrysChauffeurV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vehicule01.CrysChauffeurV.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysChauffeurV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysChauffeurV = New CrysChauffeurV
        rpt.Site = Me.Site
        Return rpt
    End Function
