<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="MasterPage.Master" CodeBehind="CParBéné.aspx.vb" Inherits="Vehicule01.WebForm35" 
...
<center><h2>Consultation&nbsp; par&nbsp; Bénéficiaire</h2></center>
        ...
        <table style="width: 99%; border-collapse: collapse;">
            <tr>
                <td style="height: 15px" align="center">
                    ...
                    <asp:Label ID="LblMatricule" runat="server" Text="Bénéficiaire" Width="126px"></asp:Label>
                            </td>
                            <td style="height: 28px">
                    ...
                    <td>
                      <asp:Button ID="BtnEnd" runat="server" Font-Bold="True" Font-Names="Garamond" 
                            ...
                            Width="110px" PostBackUrl="~/ImpBéné.aspx"  />
