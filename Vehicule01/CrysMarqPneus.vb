...
Public Class CrysMarqPneus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vehicule01.CrysMarqPneus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysMarqPneus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysMarqPneus = New CrysMarqPneus
        rpt.Site = Me.Site
        Return rpt
    End Function
