...
Public Class CrysDepenseVehi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vehicule01.CrysDepenseVehi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysDepenseVehi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysDepenseVehi = New CrysDepenseVehi
        rpt.Site = Me.Site
        Return rpt
    End Function
