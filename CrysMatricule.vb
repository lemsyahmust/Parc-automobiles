...
Public Class CrysMatricule
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vehicule01.CrysMatricule.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_A_() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrysMatricule
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysMatricule = New CrysMatricule
        rpt.Site = Me.Site
        Return rpt
    End Function
