...
Public Class CrysAutre_Frais
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vehicule01.CrysAutre_Frais.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysAutre_Frais
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysAutre_Frais = New CrysAutre_Frais
        rpt.Site = Me.Site
        Return rpt
    End Function
